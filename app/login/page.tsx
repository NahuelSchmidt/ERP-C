 ...
 * app/login/page.tsx
 *
 * Página de inicio de sesión del ERP.
 *
 * Formulario con:
 *   - Email del usuario
 *   - Contraseña
 *   - Slug del tenant (empresa) — permite que el mismo usuario acceda a
 *     múltiples empresas con el mismo email
 *
 * Stack: React Hook Form + Zod (validación) + Tailwind CSS (estilos)
 * Nota: shadcn/ui aún no está inicializado, se usan clases Tailwind directamente.
 */
...
const loginSchema = z.object({
  ...
  // tenantSlug siempre es string (vacío si no se especifica)
  tenantSlug: z.string(),
})

// Inferimos el tipo directamente del input del schema (sin transforms)
